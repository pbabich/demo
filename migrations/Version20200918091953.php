 ...
 */
final class Version20200918091953 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE news ADD user_id INT NOT NULL, ADD created_at DATETIME NOT NULL, ADD is_published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE news DROP user_id, DROP created_at, DROP is_published');
    }
}
